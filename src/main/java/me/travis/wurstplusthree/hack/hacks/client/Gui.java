...
public class Gui extends Hack {
    ...
    public ColourSetting headButtonColor = new ColourSetting("Head Button", new Colour(130, 23, 160, 255), colors);
    ...
    public ColourSetting buttonColor = new ColourSetting("Button", new Colour(180, 64, 84, 255), colors);
